...
def get_static_view(lng, lat):
    ...
    _url_complete = _url_prefix + '&ak=' + _ak + '&width=280&height=512&location='+ '&width=1024&height=1024'+ \
        '&center='+ str(numpy.round(lng, decimals=6)) + ',' + str(numpy.round(lat, decimals=6)) + '&zoom=13'+ '&markers='\
